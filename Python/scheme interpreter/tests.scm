...
(eval (car '((+ 2 3) b)))
; expect 5
(define x (begin (- 2 1) (+ 3 2)))
; expect x
x
; expect 5
(begin (define x (+ x 2)) (+ 2015 1))
; expect 2016
x
; expect 7
(begin (print 3) (cons 1 2))
; expect (1 . 2)
(and 1 2)
; expect 2
(and 1 False)
...
(or 1 2)
; expect 1
(or False False False False False 7)
; expect 7
(or (< 2 3) (< (+ 2 3) 4))
; expect True
(or true 1/0)
...
(if (and (< 1 2) (> 3 2)) 1 2)
; expect 1
(if (or (= 1 2) (> 3 2)) (list 2 3) 2)
; expect (2 3)
(if (or (= 1 2) (and (= 1 1) (< 2 3))) (list 2 (+ 2 (+ 3 2))) 1)
;expect (2 7)
(cond
    ((= 2 2) 'hello)
    (else 1/0))
...
(cond
    ...
    (else (+ 2 3)))
;expect 5
(define (count-partitions n m)
(cond
  ((= n 0) 1)
  ((< n 0) 0)
  ((= m 0) 0)
  (else (+ (count-partitions (- n m) m) (count-partitions n (- m 1))))))
;expect count-partitions
(count-partitions 15 15)
; expect 176
(count-partitions 20 20)
; expect 627


(define (factorial n)
  (define (fact-helper n results)
  (if (= 0 n) results
  (fact-helper (- n 1) (* n results))))
  (fact-helper n 1))
; expect factorial
(factorial 6)
; expect 720
